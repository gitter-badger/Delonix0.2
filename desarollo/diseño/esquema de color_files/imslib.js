    ...
    window.adobeIMS.config = {
        ...
        api: {
            "authorize": {
                "name": "authorize",
                "endpoint": {
                     "KulerWeb1": "https://ims-na1.adobelogin.com/ims/authorize/v1"
            ...
            "check": {
                "name": "check/token",
                "endpoint": {
                     "KulerWeb1": "https://adobeid-na1.services.adobe.com/ims/check/v1/token"
            ...
            "check_status": {
                "name": "check/status",
                "endpoint": {
                     "KulerWeb1": "https://adobeid-na1.services.adobe.com/ims/check/v1/status"
            ...
            "logout": {
                "name": "logout",
                "endpoint": {
                     "KulerWeb1": "https://adobeid-na1.services.adobe.com/ims/logout/v1"
            ...
            "logout_token": {
                "name": "logout_token",
                "endpoint": {
                     "KulerWeb1": "https://adobeid-na1.services.adobe.com/ims/logout/v1/token"
            ...
            "profile": {
                "name": "profile",
                "endpoint": {
                     "KulerWeb1": "https://ims-na1.adobelogin.com/ims/profile/v1"
            ...
            "validate_token": {
                "name": "validate_token",
                "endpoint": {
                     "KulerWeb1": "https://ims-na1.adobelogin.com/ims/validate_token/v1"
            ...
            "avatar": {
                ...
                "endpoint": {
                     "KulerWeb1": "https://ims-na1.adobelogin.com/ims/avatar/download"
